...
model HeatingSystem_linear
    extends .ControlsBasics.Linearization.HeatingSystem_interface(final Q0=0.0, u0=0.0);
    ...
    .ControlsBasics.Linearization.HeatingSystemSS heatingSystemSS annotation(Placement(transformation(extent = {{-40.0,0.0},{-20.0,20.0}},origin = {0.0,0.0},rotation = 0.0)));
